...
/* harmony import */ var _Logout__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Logout */ "./src/components/Logout.js");
...
class Auth extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  constructor(props) {
    super();
    this.state = {
      user: null
  ...
  async componentDidMount() {
    let user = await (0,_services_auth__WEBPACK_IMPORTED_MODULE_2__.isLoggedIn)();
    console.log(user);
    this.setState({
      user
    });
  ...
  render() {
    ...
    if (this.state.user === null) {
      ...
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "You are not logged in"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Login__WEBPACK_IMPORTED_MODULE_3__["default"], null));
    } else {
      console.log(this.state.user);
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, "Logged in as : ", this.state.user.email), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Logout__WEBPACK_IMPORTED_MODULE_4__["default"], null));
    }
  }
...
}, "Cards"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
  to: "/profile",
  style: {
    fontSize: `var(--font-sm)`,
    textDecoration: `none`
  }
}, "Profile"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("img", {
  alt: "Kuroco logo",
  height: 20,
  style: {
    margin: 0
...
/* harmony import */ var gatsby__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gatsby */ "./.cache/gatsby-browser-entry.js");
/* harmony import */ var _services_auth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/auth */ "./src/services/auth.js");
/* harmony import */ var _authAxios__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../authAxios */ "./authAxios.js");
...
class Login extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  constructor(...args) {
    ...
    this.handleSubmit = async event => {
      ...
      try {
        await (0,_services_auth__WEBPACK_IMPORTED_MODULE_2__.handleLogin)(this.state);
      } catch (e) {
        window.alert(e);
...
class Logout extends (react__WEBPACK_IMPORTED_MODULE_1___default().Component) {
  constructor(...args) {
    super(...args);
    ...
    this.handleSubmit = async event => {
      ...
      await (0,_services_auth__WEBPACK_IMPORTED_MODULE_2__.handleLogout)();
...
const profile = () => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_1__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Auth__WEBPACK_IMPORTED_MODULE_2__["default"], null)));
...
/* harmony export */   "loggedUser": () => (/* binding */ loggedUser)
/* harmony export */ });
/* harmony import */ var _authAxios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../authAxios */ "./authAxios.js");

var loggedUser = null;
const isBrowser = () => typeof window !== "undefined";
const getUser = () => isBrowser() && window.localStorage.getItem("gatsbyUser") ? JSON.parse(window.localStorage.getItem("gatsbyUser")) : {};
...
const setAccessTokenOnRequestHeader = rcmsApiAccessToken => {
  _authAxios__WEBPACK_IMPORTED_MODULE_0__["default"].defaults.headers.common = {
...
const handleLogin = async ({
  ...
  } = await _authAxios__WEBPACK_IMPORTED_MODULE_0__["default"].post("/4/login", {
    email,
    password
  });
  const {
  ...
  } = await _authAxios__WEBPACK_IMPORTED_MODULE_0__["default"].post("/4/token", {
    grant_token
  });
  setUser({
    username: email
...
const handleLogout = async () => {
  ...
  try {
    await _authAxios__WEBPACK_IMPORTED_MODULE_0__["default"].post("/3/logout");
  } catch {}

  setUser(null);
  setAccessTokenOnRequestHeader({
    rcmsApiAccessToken: null
  });
};
const isLoggedIn = async () => {
  try {
    const {
      data
    } = await _authAxios__WEBPACK_IMPORTED_MODULE_0__["default"].get('/4/profile');
    setUser({
      email: data.email,
      name1: data.name1,
      name2: data.name2
...
"use strict";
module.exports = JSON.parse('{"data":{"site":{"siteMetadata":{"title":"Anki app"}}}}');
