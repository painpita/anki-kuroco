...
var Header = __webpack_require__(3049);
 ...
 *
 * See: https://www.gatsbyjs.com/docs/use-static-query/
 */const Layout=({children})=>{var _data$site$siteMetada;const data=(0,gatsby_browser_entry.useStaticQuery)("3649515864");return/*#__PURE__*/react.createElement(react.Fragment,null,/*#__PURE__*/react.createElement(Header/* default */.Z,{siteTitle:((_data$site$siteMetada=data.site.siteMetadata)===null||_data$site$siteMetada===void 0?void 0:_data$site$siteMetada.title)||`Title`}),/*#__PURE__*/react.createElement("div",{style:{margin:`0 auto`,maxWidth:`var(--size-content)`,padding:`var(--size-gutter)`}},/*#__PURE__*/react.createElement("main",null,children),/*#__PURE__*/react.createElement("footer",{style:{marginTop:`var(--space-5)`,fontSize:`var(--font-sm)`}})));};Layout.propTypes={children:(prop_types_default()).node.isRequired};/* harmony default export */ const layout = ((/* unused pure expression or super */ null && (Layout)));
// EXTERNAL MODULE: ./src/components/seo.js + 1 modules
var seo = __webpack_require__(8183);
;// CONCATENATED MODULE: ./src/pages/card-map.js
const StaticFilesDemo=()=>JSON.stringify({"version":3,"sourceRoot":"","sources":["card.sass"],"names":[],"mappings":"AAAQ;AAER;EACI;EACA;EACA;EACA;;AACA;EACI;EACA;;;AAER;EACI;EACA;EACA;EACA;EACA;EACA;EACA;EACA;EACA;;AACA;EACI;;AACJ;EACI;;;AAGR;EACI;EACA;EACA;EACA;EACA;EACA;EACA;EACA;EACA;EACA;EACA;EACA;;;AAEJ;EACI;EACA;EACA;EACA;EACA;EACA;EACA;EACA;EACA;EACA;EACA;;AACA;EACI;EACA;;AACA;EACI;;AACR;EACI;EACA;EACA;EACA;EACA;;AACA;EACI;EACA","file":"card.css"});/* harmony default export */ const card_map = (StaticFilesDemo);
...
;
//# sourceMappingURL=component---src-pages-card-map-js.js.map